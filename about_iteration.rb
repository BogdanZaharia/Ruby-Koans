...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject takes as argument the sum/product calculated at the previous step (starts with 0 in step 1) and calculates the sum/product between the argument and each item in the list.
  end
